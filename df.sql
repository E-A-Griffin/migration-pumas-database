create table df1 (
  ...
  age numeric(2),
  citizenship_status varchar(3),
  naturalization_year numeric(4),
  worker_class varchar(3),
  self_care_difficulty varchar(3),
  hearing_difficulty varchar(3),
  vision_difficulty varchar(3),
  independent_living_difficulty varchar(3),
  ambulatory_difficulty varchar(3),
  vet_disability_rating varchar(3),
  vet_disability varchar(3),
  cognitive_difficulty varchar(3),
  english_ability varchar(3),
  gave_birth_last_year varchar(3),
  grandparents_w_grandchildren varchar(3),
  length_responsible_for_grandchildren varchar(3),
  grandparents_responsible_for_grandchildren varchar(3),
  insurance_through_employer varchar(3),
  insurance_purchased_directly varchar(3),
  medicare varchar(3),
  medicaid_etc varchar(3),
  tricare varchar(3),
  va varchar(3),
  ind_health_service varchar(3),
  interest_div_rental_income_last_year numeric(6),
  travel_time_to_work numeric(3),
  vehicle_occupancy numeric(2),
  means_of_transportation_to_work varchar(3),
  language_other_than_english varchar(3),
  marital_status varchar(3),
  divorced_in_last_year varchar(3),
  married_in_last_year varchar(3),
  n_times_married varchar(3),
  widowed_in_last_year varchar(3),
  year_last_married numeric(4),
  mobility_status varchar(3),
  military_service varchar(3),
  served_after_09_2001 varchar(3),
  served_from_08_1990_to_08_2001 varchar(3),
  served_from_05_1975_to_07_1990 varchar(3),
  served_from_08_1964_to_04_1975 varchar(3),
  served_from_02_1955_to_07_1964 varchar(3),
  served_from_07_1950_to_01_1955 varchar(3),
  served_from_01_1947_to_06_1950 varchar(3),
  served_from_12_1941_to_12_1946 varchar(3),
  served_before_11_1941 varchar(3),
  temp_absence_from_work varchar(3),
  available_for_work varchar(3),
  on_layoff varchar(3),
  looking_for_work varchar(3),
  informed_of_recall varchar(3),
  other_income_last_year numeric(6),
  public_assistance_income_last_year numeric(5),
  relationship_to_ref_person varchar(3),
  retirement_income_last_year numeric(6),
  school_enrollment varchar(3),
  grade_attending varchar(4),
  educational_attainment numeric(3,1),
  ...
  last_worked varchar(3),
  weeks_worked_last_year varchar(3),
  weeks_worked_2019_or_later numeric(2),
  worked_last_week varchar(3),
  year_of_entry numeric(4),
  ancestry_recode varchar(3),
  ancestry_recode_first_entry varchar(3),
  ancestry_recode_second_entry varchar(3),
  decade_of_entry varchar(3),
  disability_recode varchar(3),
  number_of_vehicles varchar(3),
  parents_employment varchar(3),
  employment_status_recode varchar(3),
  recode_field_of_degree_first_entry varchar(4),
  recode_field_of_degree_second_entry varchar(4),
  health_insurance_recode varchar(3),
  hispanic_origin_recode varchar(3),
  industry_recode_for_2018_or_later varchar(6),
  time_of_arrival_at_work varchar(5),
  ...
  married_spouse_present varchar(3),
  NAICS_recode_for_2018_or_later varchar(8),
  nativity varchar(3),
  nativity_parent varchar(3),
  own_child varchar(3),
  occupation_recode_for_2018_or_later varchar(6),
  presence_and_age_of_childen varchar(3),
  ...
  private_health_cov_recode varchar(3),
  public_health_cov_recode varchar(3),
  quarter_of_birth varchar(3),
  recoded_race_code varchar(3),
  recoded_race_code2 varchar(3),
  recoded_race_code3 varchar(3),
  native_american_recode varchar(3),
  asian_recode varchar(3),
  black_recode varchar(3),
  native_hawaiian_recode varchar(3),
  n_races_represented varchar(3),
  pacific_islander_recode varchar(3),
  other_races_recode varchar(3),
  white_recode varchar(3),
  related_child varchar(3),
  field_of_degree_science_and_engineering varchar(3),
  field_of_degree_science_and_engineering_related varchar(3),
  subfamily_number varchar(3),
  subfamily_relationship varchar(3),
  SOC_codes_for_2018_and_later varchar(6),
  vet_period_of_service varchar(3),
  world_area_of_birth varchar(3),
  age_alloc_flag varchar(3),
  ancestry_alloc_flag varchar(3),
  citizenship_alloc_flag varchar(3),
  year_of_naturalization_alloc_flag varchar(3),
  class_of_worker_alloc_flag varchar(3),
  self_care_alloc_flag varchar(3),
  hearing_difficulty_alloc_flag varchar(3),
  vision_difficulty_alloc_flag varchar(3),
  disability_recode_alloc_flag varchar(3),
  independent_living_difficulty_alloc_flag varchar(3),
  ambulatory_difficulty_alloc_flag varchar(3),
  disability_rating_percentage_alloc_flag varchar(3),
  disability_rating_checkbox_alloc_flag varchar(3),
  cognitive_difficulty_alloc_flag varchar(3),
  ability_to_speak_english_alloc_flag varchar(3),
  employment_status_recode_alloc_flag varchar(3),
  gave_birth_last_year_alloc_flag varchar(3),
  field_of_degree_alloc_flag varchar(3),
  grandparents_living_w_grandchildren_alloc_flag varchar(3),
  length_of_time_responsible_for_grandchildren_alloc_flag varchar(3),
  grandparents_responsible_for_grandchildren_alloc_flag varchar(3),
  insurance_recode_alloc_flag varchar(3),
  insurance_through_employer_alloc_flag varchar(3),
  insurance_direct_alloc_flag varchar(3),
  medicare_coverage_given_through_eligibility_alloc_flag varchar(3),
  medicare_65_or_older_certain_disabilities_alloc_flag varchar(3),
  medicare_coverage_given_through_eligibility_alloc_flag2 varchar(3),
  govt_assistance_alloc_flag varchar(3),
  tricare_through_eligibility_alloc_flag varchar(3),
  trcare_alloc_flag varchar(3),
  va_alloc_flag varchar(3),
  ind_health_service_alloc_flag varchar(3),
  detailed_hispanic_origin_alloc_flag varchar(3),
  industry_alloc_flag varchar(3),
  interest_dividend_rental_income_alloc_flag varchar(3),
  time_of_departure_to_work_alloc_flag varchar(3),
  travel_time_to_work_alloc_flag varchar(3),
  vehicle_occupancy_alloc_flag varchar(3),
  means_of_transportation_alloc_flag varchar(3),
  language_other_than_english_spoken_at_home_alloc_flag varchar(3),
  language_other_than_english_alloc_flag varchar(3),
  marital_status_alloc_flag varchar(3),
  divorced_last_year_alloc_flag varchar(3),
  married_last_year_alloc_flag varchar(3),
  times_married_alloc_flag varchar(3),
  widowed_last_year_alloc_flag varchar(3),
  year_last_married_alloc_flag varchar(3),
  mobility_status_alloc_flag varchar(3),
  migration_state_alloc_flag varchar(3),
  military_periods_of_service_alloc_flag varchar(3),
  military_service_alloc_flag varchar(3),
  occupation_alloc_flag varchar(3),
  all_other_income_alloc_flag varchar(3),
  public_assistance_income_alloc_flag varchar(3),
  total_persons_earnings_alloc_flag varchar(3),
  total_persons_income_alloc_flag varchar(3),
  place_of_birth_alloc_flag varchar(3),
  place_of_work_state_alloc_flag varchar(3),
  private_health_insurance_coverage_recode_alloc_flag varchar(3),
  public_health_coverage_recode_alloc_flag varchar(3),
  detailed_race_alloc_flag varchar(3),
  relationship_alloc_flag varchar(3),
  retirement_income_alloc_flag varchar(3),
  grade_attending_alloc_flag varchar(3),
  highest_education_alloc_flag varchar(3),
  school_enrollment_alloc_flag varchar(3),
  self_employment_income_alloc_flag varchar(3),
  sex_allocation_flag varchar(3),
  supplementary_security_income_alloc_flag varchar(3),
  social_security_income_alloc_flag varchar(3),
  wages_and_salary_income_alloc_flag varchar(3),
  usual_hours_worked_per_week_last_year_alloc_flag varchar(3),
  last_worked_alloc_flag varchar(3),
  weeks_worked_numeric_last_year_alloc_flag varchar(3),
  weeks_worked_last_year_alloc_flag varchar(3),
  worked_last_week_alloc_flag varchar(3),
  year_of_entry_alloc_flag varchar(3),
